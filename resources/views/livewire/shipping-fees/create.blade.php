<div>
    <div class="modal fade" id="create_shipping_fees" wire:ignore.self tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">انشاء شحن جديد</h5>
                ...
                <form class="row g-2" wire:submit.prevent="save">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">تسجيل شحن</button>
