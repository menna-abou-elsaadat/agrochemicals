<div>
    <div class="modal fade" id="edit_payment_method" wire:ignore.self tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">تعديل طريقة دفع</h5>
                ...
                <form class="row g-2" wire:submit.prevent="save">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">تعديل طريقة الدفع</button>
