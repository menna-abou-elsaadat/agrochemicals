            ...
            <div class="row">
                <div class="col-12 mb-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="h2 mb-md-0 text-white fw-light">التصنيفات</h1>
                        <div class="page-action">
                            <!-- btn:: create new category -->
                            <button class="btn d-none d-sm-inline-flex rounded-pill" data-bs-toggle="modal" data-bs-target="#create_category" type="button">
                        ...
                        <span class="me-1 d-none d-lg-inline-block">انشاء تصنيف جديد</span>
                        </button>
                        <!-- btn:: download -->
                    </div>
                </div>
                                ...
                                <div class="row dt-row">
                                    <div class="col-sm-12">
                                        <div class="row row-cards">
                                            <div class="col-12">
                                               <x-table :columns="$columns" :page="$page" :perPage="$perPage" :items="$categories" :sortColumn="$sortColumn" :sortDirection="$sortDirection" isModalDelete="true" isModalEdit="true">
                                               </x-table> 
                                            </div>
                                        </div>
                                    </div>
