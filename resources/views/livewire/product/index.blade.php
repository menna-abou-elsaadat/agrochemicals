            ...
            <div class="row">
                <div class="col-12 mb-2">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="me-1 d-none d-lg-inline-block">انشاء صنف جديد</span>
                        </button>
                        <!-- btn:: download -->
                    </div>
                </div>
                                ...
                                <div class="row dt-row">
                                    <div class="col-sm-12">
                                        <div class="row row-cards">
                                            <div class="col-12">
                                              <x-table :columns="$columns" :page="$page" :perPage="$perPage" :items="$products" :sortColumn="$sortColumn" :sortDirection="$sortDirection" isModalDelete="true" isModalEdit="true" isModalView="true">
                                               </x-table>
                                            </div>
                                        </div>
                                    </div>
