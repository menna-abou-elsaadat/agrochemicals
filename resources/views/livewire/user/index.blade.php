                                ...
                                <div class="row dt-row">
                                    <div class="col-sm-12">
                                        <div class="row row-cards">
                                            <div class="col-12">
                                                <x-table :columns="$columns" :page="$page" :perPage="$perPage" :items="$users" :sortColumn="$sortColumn" :sortDirection="$sortDirection" isModalDelete="true" isModalView="true" isModalEdit="true">
